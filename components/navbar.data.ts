...
export const buildNavbarSections = ({
  ...
  return [
    ...
    },
    {
      ...
      visible: true,
      items: [
        { name: labels.nonCompliance, href: "/erp/hcm/non-compliance" },
        { name: labels.overtime, href: "/erp/hcm/overtime" },
        { name: labels.vacations, href: "/erp/hcm/vacations" },
        { name: labels.settlement, href: "/erp/hcm/settlement" },
        { name: labels.commissions, href: "/erp/hcm/commissions" },
        { name: labels.bonuses, href: "/erp/hcm/bonuses" },
        { name: labels.perDiem, href: "/erp/hcm/per-diem" },
        {
          name: labels.payrollProvisions,
          href: "/erp/hcm/payroll-provisions",
        },
        { name: labels.leavesAbsences, href: "/erp/hcm/leaves-and-absences" },
        { name: labels.pila, href: "/erp/hcm/social-security-pila" },
      ],
    },
  ];
};
