...
export const buildNavbarSections = ({
    ...
    const labels = {
        ...
        kpis: "KPIs",
        sla: "SLA",
        incomeStatement: locale === "es" ? "Estado de resultados" : "Income statement",
        commissions: locale === "es" ? "Comisiones" : "Commissions",
        warehouseInventory: locale === "es" ? "Bodega e inventario" : "Warehouse & Inventory",
        history: locale === "es" ? "Historial" : "History",
        coordinationCenter: locale === "es" ? "Centro de coordinación" : "Coordination Center",
        ...
        productionHistory: locale === "es" ? "Historial de producción" : "Production history",
        view: locale === "es" ? "Visualizar" : "View",
        internalWarranties: locale === "es" ? "Garantías internas" : "Internal warranties",
        externalWarranties: locale === "es" ? "Garantías externas" : "External warranties",
        ...
        bankReconciliation: locale === "es" ? "Conciliación bancaria" : "Bank reconciliation",
        factoring: "Factoring",
        ...
        initialApproval: locale === "es" ? "Aprobación inicial" : "Initial approval",
        ...
        moldingTemplates: locale === "es" ? "Plantillas de moldería" : "Molding templates",
        ...
        payrollProvisions: locale === "es" ? "Provisiones de nómina" : "Payroll provisions",
        leavesAbsences: locale === "es" ? "Permisos y ausencias" : "Leaves & absences",
        pila: locale === "es" ? "Seguridad social (PILA)" : "Social security (PILA)",
    };
    ...
    return [
        ...
        },
        {
            ...
            items: [
                ...
                { name: labels.productionHistory, href: "/comercial/historial-produccion" },
                { name: labels.view, href: "/comercial/visualizar" },
                { name: labels.internalWarranties, href: "/comercial/garantias/interna" },
                { name: labels.externalWarranties, href: "/comercial/garantias/externa" },
            ],
        },
        {
            key: "contabilidad",
            ...
            items: [
                ...
                { name: labels.deliveryNotes, href: "/erp/accounting-module/delivery-notes" },
                { name: labels.cashReceipt, href: "/erp/accounting-module/cash-receipt" },
                { name: labels.deposits, href: "/erp/accounting-module/deposits" },
                { name: labels.bankReconciliation, href: "/erp/accounting-module/bank-reconciliation" },
                { name: labels.withholdings, href: "/erp/accounting-module/withholdings" },
                { name: labels.factoring, href: "/erp/accounting-module/factoring" },
                { name: labels.accountsReceivable, href: "/erp/accounting-module/accounts-receivable" },
                { name: labels.incomeStatement, href: "/erp/accounting-module/income-statement" },
        ...
        },
        {
            ...
            items: [
                ...
                { name: labels.initialApproval, href: "/produccion/aprobacion-inicial" },
        ...
        },
        {
            ...
            visible: true,
            items: [
                { name: labels.legalModule, href: "/legal" },
            ],
        },
        {
            key: "rh",
...
export const buildNavbarOtherItems = ({
    ...
    const items: SectionItem[] = [
        ...
        { name: locale === "es" ? "Notificaciones" : "Notifications", href: "/notifications" },
        { name: locale === "es" ? "Opciones" : "Options", href: "/options" },
        { name: locale === "es" ? "Envíos" : "Shipments", href: "/envios" },
    ];

    if (isAdmin) {
        items.push({ name: locale === "es" ? "Administración" : "Administration", href: "/admin" });
    }
