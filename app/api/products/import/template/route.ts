...
export async function GET(request: Request) {
  ...
  const notes = [
    ...
    "# En creación, puedes dejar algunos precios vacíos (se guardan como null).",
    "# Si envías priceCopR1, se calcula priceCopInternational (R1 * 1.19).",
    "# priceUSD solo se calcula cuando hay TRM vigente y priceCopR1.",
