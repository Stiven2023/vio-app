            ...
            <>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  {showValue(supplier.supplierCode)}
                </div>
                <div>
                  <span className="font-semibold">Name:</span>{" "}
                  {showValue(supplier.name)}
                </div>
                <div>
                  <span className="font-semibold">ID Type:</span>{" "}
                  {showValue(supplier.identificationType)}
                </div>
                <div>
                  <span className="font-semibold">Identification:</span>{" "}
                  {showValue(supplier.identification)}
                </div>
                <div>
                  <span className="font-semibold">DV:</span>{" "}
                  {showValue(supplier.dv)}
                </div>
                <div>
                  <span className="font-semibold">Branch:</span>{" "}
                  {showValue(supplier.branch)}
                </div>
                <div>
                  <span className="font-semibold">Tax regime:</span>{" "}
                  {showValue(supplier.taxRegime)}
                </div>
                <div>
                  <span className="font-semibold">Active:</span>{" "}
                  {showValue(supplier.isActive)}
                </div>
              </div>
              ...
              <div className="border-t pt-3 grid grid-cols-2 gap-3">
                <div>
                  ...
                  {showValue(supplier.contactName)}
                </div>
                <div>
                  <span className="font-semibold">Email:</span>{" "}
                  {showValue(supplier.email)}
                </div>
                <div>
                  <span className="font-semibold">Int. code:</span>{" "}
                  {showValue(supplier.intlDialCode)}
                </div>
                <div>
                  <span className="font-semibold">Mobile:</span>{" "}
                  {showValue(supplier.mobile)}
                </div>
                <div>
                  <span className="font-semibold">Full mobile:</span>{" "}
                  {showValue(supplier.fullMobile)}
                </div>
                <div>
                  <span className="font-semibold">Local code:</span>{" "}
                  {showValue(supplier.localDialCode)}
                </div>
                <div>
                  <span className="font-semibold">Landline:</span>{" "}
                  {showValue(supplier.landline)}
                </div>
                <div>
                  <span className="font-semibold">Extension:</span>{" "}
                  {showValue(supplier.extension)}
                </div>
                <div>
                  <span className="font-semibold">Full landline:</span>{" "}
                  {showValue(supplier.fullLandline)}
                </div>
              </div>
              ...
              <div className="border-t pt-3 grid grid-cols-2 gap-3">
                <div>
                  ...
                  {showValue(supplier.address)}
                </div>
                <div>
                  <span className="font-semibold">Postal code:</span>{" "}
                  {showValue(supplier.postalCode)}
                </div>
                <div>
                  <span className="font-semibold">Country:</span>{" "}
                  {showValue(supplier.country)}
                </div>
                <div>
                  <span className="font-semibold">Department:</span>{" "}
                  {showValue(supplier.department)}
                </div>
                <div>
                  <span className="font-semibold">City:</span>{" "}
                  {showValue(supplier.city)}
                </div>
              </div>

              <div className="border-t pt-3 grid grid-cols-2 gap-3">
                <div>
                  <span className="font-semibold">Has credit:</span>{" "}
                  {showValue(supplier.hasCredit)}
                </div>
                <div>
                  <span className="font-semibold">Promissory note #:</span>{" "}
                  {showValue(supplier.promissoryNoteNumber)}
                </div>
                <div>
                  <span className="font-semibold">Promissory note date:</span>{" "}
                  {showValue(supplier.promissoryNoteDate)}
                </div>
              </div>
              ...
              <div className="border-t pt-3 space-y-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  ...
                  <Button
                    ...
                    variant="flat"
                    onPress={() =>
                      openDocument("Pasaporte", supplier.passportDocumentUrl)
                    }
                  >
                    View passport
                  </Button>
