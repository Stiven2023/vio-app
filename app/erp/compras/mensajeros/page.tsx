...
export default async function ComprasMensajerosPage() {
  ...
  return (
    <div className="container mx-auto max-w-7xl px-6 pt-16">
      <h1 className="text-2xl font-bold">Mensajeros</h1>
      <p className="mt-1 text-default-600">
        CRUD operativo de mensajeros para asignación en envíos.
      </p>
      <div className="mt-6">
        <MessengersCrudTab
