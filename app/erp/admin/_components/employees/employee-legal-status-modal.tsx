...
export function EmployeeLegalStatusModal({
  employee,
  isOpen,
  onOpenChange,
}: {
    ...
    <Modal isOpen={isOpen} size="3xl" onOpenChange={onOpenChange}>
      <ModalContent>
        <ModalHeader className="flex gap-2">
          ...
          <span>Estado Jurídico - {employeeName}</span>
        </ModalHeader>
        <Divider />
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-semibold text-warning-900">
                      Empleado será desactivado automáticamente
                    </p>
                    <p className="text-xs text-warning-800 mt-1">
                      {status === "EN_REVISION"
                        ? "El empleado no podrá operar mientras su estado esté en revisión."
                        : "El empleado no podrá operar mientras esté bloqueado."}
                    </p>
                  </div>
                </div>
              </CardBody>
