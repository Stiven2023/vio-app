...
export default async function PrefacturasWorkflowPage() {
  ...
  return (
    <div className="container mx-auto max-w-7xl px-6 pt-16">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold">Pre-invoices (Sales)</h1>
          <p className="mt-1 text-default-600">
            All pre-invoices: type F can be sent to SIIGO, type R generates remision.
          </p>
        </div>
        <a
