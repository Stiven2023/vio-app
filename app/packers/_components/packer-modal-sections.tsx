...
export type PackerSectionsFormState = {
  name: string;
...
export function PackerIdentificationSection({
  form,
  errors,
  identificationTypes,
  onStringFieldChange,
...
export function PackerContactSection({
  form,
  errors,
  onStringFieldChange,
}: SectionsProps) {
...
export function PackerPhoneSection({
  form,
  onStringFieldChange,
}: SectionsProps) {
  return (
...
export function PackerLocationSection({
  form,
  errors,
  onStringFieldChange,
  onActiveChange,
