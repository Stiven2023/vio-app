...
export function ConfectionistLegalStatusModal({
  confectionist,
  isOpen,
  onOpenChange,
}: {
  ...
  useEffect(() => {
    if (!isOpen || !confectionist) return;
    ...
    <Modal isOpen={isOpen} size="3xl" onOpenChange={onOpenChange}>
      <ModalContent>
        <ModalHeader className="flex gap-2">
          ...
          <span>Estado Jurídico - {confectionist.name}</span>
        </ModalHeader>
        <Divider />
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-semibold text-warning-900">
                      Confeccionista será desactivado automáticamente
                    </p>
                    <p className="text-xs text-warning-800 mt-1">
                      {status === "EN_REVISION"
                        ? "El confeccionista no podrá operar mientras su estado esté en revisión."
                        : "El confeccionista no podrá operar mientras esté bloqueado."}
                    </p>
                  </div>
                </div>
              </CardBody>
