...
const leaderAllowed = ALL_STATUSES.filter((status) => status !== ORDER_ITEM_STATUS.CANCELADO);

const STATUS_TRANSITIONS: Record<string, string[]> = {
  PENDIENTE: [ORDER_ITEM_STATUS.APROBACION],
  APROBACION: [ORDER_ITEM_STATUS.PENDIENTE_PRODUCCION, ORDER_ITEM_STATUS.PENDIENTE_PRODUCCION_ACTUALIZACION],
  PENDIENTE_PRODUCCION: [
  ...
  RECHAZADO_CAMBIO: [ORDER_ITEM_STATUS.PENDIENTE_PRODUCCION_ACTUALIZACION],
  COMPLETADO: [],
  CANCELADO: [],
};
